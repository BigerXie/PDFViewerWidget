$("body").append('<script type="text/javascript" src="../Common/extensions/PDFWidget/ui/pdfviewer/jslibrary/pdf.js">\x3c/script>');pdfjsLib.GlobalWorkerOptions.workerSrc="../Common/extensions/PDFWidget/ui/pdfviewer/jslibrary/pdf.worker.js";
...
0,w="width",x,r,k=1,n=(new Date).getTime()+"_"+Math.floor(1E3*Math.random()),F,G,z,q=TW.Runtime.convertLocalizableString("[[PDFWidget.pdfviewer.page]]","Page"),J=TW.Runtime.convertLocalizableString("[[PDFWidget.pdfviewer.fitpage]]","Fit Page"),K=TW.Runtime.convertLocalizableString("[[PDFWidget.pdfviewer.fitwidth]]","Fit Width"),L=TW.Runtime.convertLocalizableString("[[PDFWidget.pdfviewer.error]]","The file is not available or is not a valid PDF document");this.runtimeProperties=function(){return{supportsAutoResize:!0,
needsDataLoadingAndError:!1}};this.renderHtml=function(){return'<div class="widget-content widget-pdfviewer widget-pdfviewer-'+a+'">  <div class="widget-pdfviewer-page">    <button class="widget-pdfviewer-page_num widget-pdfviewer-page_num-'+a+'">'+q+':</button>    <select class="widget-pdfviewer-page_select widget-pdfviewer-page_select-'+a+'"></select>    <select class="widget-pdfviewer-outline_select widget-pdfviewer-outline_select-'+a+'"></select>    <button class="widget-pdfviewer-page_loading widget-pdfviewer-page_loading-'+
